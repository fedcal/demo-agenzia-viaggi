...
hero:
  ...
  actions:
    - theme: brand
      text: Demo live
      link: https://agenzia-viaggi.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-agenzia-viaggi
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Agenzia Viaggi.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Agenzia Viaggi** in Italia.
...
Il mercato italiano delle PMI per **Agenzia Viaggi** ha caratteristiche specifiche:
...
```bash
npm run build
npm run serve:ssr:agenzia-viaggi
# → http://localhost:4000
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-agenzia-viaggi)
