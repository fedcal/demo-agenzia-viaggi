...
URL: `https://agenzia-viaggi.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `agenzia-viaggi.demo.federicocalo.dev`
...
- Output directory: `dist/agenzia-viaggi/browser`
...
URL: `https://fedcal.github.io/federico-demo-agenzia-viaggi/`
...
- `base: /federico-demo-agenzia-viaggi/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `agenzia-viaggi-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   agenzia-viaggi-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `agenzia-viaggi-docs.federicocalo.dev`
